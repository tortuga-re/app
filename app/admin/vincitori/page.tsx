...
export default function WinnersAdminPage() {
  ...
  const save = async (event: React.FormEvent) => {
    ...
    const response = await fetch("/api/tortuga-winners/admin", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ teamName, evening }) });
