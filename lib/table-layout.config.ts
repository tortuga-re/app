...
export const TORTUGA_TABLE_LAYOUTS: RoomLayoutConfig[] = [
  {
    ...
    tables: [
      ...
      { id: "24-27", label: "Tavoli 24 + 27", minPax: 5, maxPax: 8, roomCode: "da1d57f0-e0d5-4d7e-86be-9f8300f388b8", roomName: "Sala Centrale", type: "combo", members: ["24", "27"] },
      { id: "20-21", label: "Tavoli 20 + 21", minPax: 7, maxPax: 10, roomCode: "da1d57f0-e0d5-4d7e-86be-9f8300f388b8", roomName: "Sala Centrale", type: "combo", members: ["20", "21"] },
      { id: "22-23", label: "Tavoli 22 + 23", minPax: 7, maxPax: 10, roomCode: "da1d57f0-e0d5-4d7e-86be-9f8300f388b8", roomName: "Sala Centrale", type: "combo", members: ["22", "23"] },
