...
import { LayoutDashboard, Tv, Megaphone, Gamepad2, ImageIcon, LogOut, Menu, X, Newspaper, Trophy, ReceiptText, ShoppingBag, Radio } from "lucide-react";
import { useState } from "react";
import { PanicButton } from "./panic-button";

const navGroups = [
  { label: "Operatività", items: [{ name: "Cruscotto", href: "/admin", icon: LayoutDashboard }, { name: "Serata Live", href: "/admin/serata-live", icon: Radio }, { name: "Live TV", href: "/admin/live-tv", icon: Tv }, { name: "Giochi Live", href: "/admin/games", icon: Gamepad2 }] },
