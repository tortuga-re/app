...
const cards: Record<string, GiftCard> = {
  evening: { id: "evening", title: "Una serata al Tortuga", image: "/gift-cards/gift-una-serata-al-tortuga.png", purchaseUrl: "https://gift.cooperto.it/in/f85dfad0-6a98-4f" },
  birthday: { id: "birthday", title: "Buon compleanno, pirata", image: "/gift-cards/gift-buon-compleanno-pirata.png", purchaseUrl: "https://gift.cooperto.it/in/c73cd7f6-bdbb-4144-b057-2e45969b65d5" },
  crew: { id: "crew", title: "Per la tua ciurma", image: "/gift-cards/gift-per-la-tua-ciurma.png", purchaseUrl: "https://gift.cooperto.it/in/8da4f7e8-ad73-47cf-a37e-db0a76118983" },
  special: { id: "special", title: "Un regalo speciale", image: "/gift-cards/gift-un-regalo-speciale.png", purchaseUrl: "https://gift.cooperto.it/in/cb26a59f-fa66-465d-9264-adfa0f9bcc1b" },
  treat: { id: "treat", title: "Ti offro io", image: "/gift-cards/gift-ti-offro-io.png", purchaseUrl: "https://gift.cooperto.it/in/f8533db9-22e0-4b6e-be58-b257ebc33a02" },
  thanks: { id: "thanks", title: "Grazie, Capitano", image: "/gift-cards/gift-grazie-capitano.png", purchaseUrl: "https://gift.cooperto.it/in/b942ceef-a753-4f1f-9c6d-4bc279ca60a2" },
  mission: { id: "mission", title: "Missione compiuta", image: "/gift-cards/gift-missione-compiuta.png", purchaseUrl: "https://gift.cooperto.it/in/91ddd944-7af2-4d95-bd7f-5607bf65fb3d" },
  toast: { id: "toast", title: "Brindiamo?", image: "/gift-cards/gift-brindiamo.png", purchaseUrl: "https://gift.cooperto.it/in/7e670063-7629-4556-aec1-82ef457a390a" },
  couple: { id: "couple", title: "Una rotta per due", image: "/gift-cards/gift-una-rotta-per-due.png", purchaseUrl: "https://gift.cooperto.it/in/728aa922-d49d-42c0-b1b7-42752eff62a8" },
  party: { id: "party", title: "Festa a bordo", image: "/gift-cards/gift-festa-a-bordo.png", purchaseUrl: "https://gift.cooperto.it/in/6548a722-b909-4928-b638-0437a0200aaf" },
  round: { id: "round", title: "Offro un giro alla ciurma", image: "/gift-cards/gift-offro-un-giro-alla-ciurma.png", purchaseUrl: "https://gift.cooperto.it/in/08373b55-10cc-41dd-bf88-1687fbe41413" },
  target: { id: "target", title: "Hai fatto centro", image: "/gift-cards/gift-hai-fatto-centro.png", purchaseUrl: "https://gift.cooperto.it/in/07872e39-556c-430e-a33c-0c4229030961" },
};
