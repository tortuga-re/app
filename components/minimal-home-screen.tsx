...
import { BookOpen, CalendarDays, ChevronRight, Clock3, Users, UtensilsCrossed } from "lucide-react";
...
export function MinimalHomeScreen() {
  ...
  const beforeHighlights = <>
    ...
    {liveGame?.active_game ? <section className="menu-context-button game-context-card"><div><p className="minimal-eyebrow">Come giocare stasera</p><span>I passaggi vanno eseguiti in ordine</span><ol><li>Collegati al wi-fi “TORTUGA”</li><li>PSW: “PERLANERA”</li></ol><a href={liveGames[liveGame.active_game].url} target="_blank" rel="noreferrer">Clicca qui <ChevronRight /></a></div></section> : null}
  </>;
