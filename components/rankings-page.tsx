...
export function RankingsPage() {
  ...
  return <main className="minimal-page rankings-page pb-28"><div className="minimal-overlap-sheet rankings-sheet"><header className="overlap-sheet-intro"><p className="minimal-eyebrow">La plancia della ciurma</p><h1>Classifiche</h1><p>Le squadre, le Leggende e i piatti che hanno conquistato il Tortuga.</p></header><div className="space-y-6">
    ...
    <LeaderboardPanel icon={<Crown size={15} />} title="Hall of Legends" subtitle="Il registro storico dei pirati che hanno raggiunto il rango Leggenda"><LeaderboardRows loading={loading} items={legends.map((legend, index) => ({ id: `${legend.nickname}-${legend.legend_number}`, position: legend.legend_number || index + 1, name: legend.nickname, value: legend.real_name ?? "" }))} empty="Nessun pirata ha ancora inciso il proprio nome nella storia..." /></LeaderboardPanel>
