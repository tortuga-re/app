        ...
        <header className="mb-6">
          <div className="panel rounded-[2.15rem] px-5 py-4">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="rounded-full border border-[var(--border)] bg-[var(--accent-soft)] px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.28em] text-[var(--accent-strong)]">
                Isla Loca
              </div>
            </div>
          </div>
